...
class TopicListing extends StatefulWidget {
  const TopicListing({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
          ...
          appBar: shopappBar('Choose Topic  to be discuss',context),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Topics.length==0 ?
                  loadmytopics():
                  (Topics.length!=0 && Topics[0]['status']=='ok')  ?
                  Column(
                    children: [
                      Column(
                        children: [
                          SizedBox(height: 5,),
                          Center(child: Text('Select a topic and get in touch with our Success team',textAlign: TextAlign.center,)),
                          SizedBox(height: 5,),
                        ],
                      ),
                      for(int k=0; k<Topics.length; k++)
                        Padding(
                          ...
                          child: TextButton(
                              onPressed: (){
                                     Navigator.of(context).push(MaterialPageRoute(builder: (context)=> TopicsDetailMsg(data: Topics[k])));
                              },
                              child: Container(
                                ...
                                child:
                               ListTile(title: Text('${Topics[k]['h_title']}'),
                               subtitle: Text('${Topics[k]['h_desc']}'),
                               trailing: Icon(Icons.arrow_circle_right_outlined ,color: UiColors.primary,),
                               )
                              )
                          ),
                        )
