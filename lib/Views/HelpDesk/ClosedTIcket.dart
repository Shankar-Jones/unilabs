...
class ClosedTickets extends StatefulWidget {
  const ClosedTickets({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
          ...
          appBar: shopappBar('Closed Tickets',context),
            ...
            child: Padding(
              ...
              StreamBuilder(
                                        stream: FirebaseFirestore.instance
                                            .collection("unobilabs_tickets").where('t_from',isEqualTo: '${UlStorage.read('mob')}').where('t_status',isEqualTo: 'Closed').snapshots(),
                          ...
                          child: TextButton(
                              onPressed: (){
                                     Navigator.of(context).push(MaterialPageRoute(builder: (context)=> TicketDetails(data:snapshot.data!.docs[k])));
                              },
                              child: Container(
