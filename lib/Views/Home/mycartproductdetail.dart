...
class MycartProductDetails extends StatefulWidget {
  final data;
  final barcode;
  final qty;
  final price;
  const MycartProductDetails({Key? key, this.data, this.barcode, this.qty, this.price}) : super(key: key);

  @override
  _MycartProductDetailsState createState() => _MycartProductDetailsState();
}

class _MycartProductDetailsState extends State<MycartProductDetails> {
...
Apicallforproductdetail() async{
  List a=await GetMethod("addProducts/RHVR5A/${widget.barcode}");
  setState(() {
    pdata=a;
    print(pdata);
  ...
  if(pdata[0]['p_type']){
    for(int k=0;k<pdata[0]['p_price'];k++){
      if(widget.price==pdata[0]['p_sellingprice']["${k}"]['p_price']){
          stableval=k;
      }
    }
  }
...
inval.text=indexval.toString();
      return SafeArea(
          child: Scaffold(
            ...
            appBar: shopappBar("Update Detail",context),
            body: SingleChildScrollView(
              child:
              pdata.length==0 ?  SpinKitHourGlass(
                                ...
                                GestureDetector(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                        ...
                                        child: Image.network('https://unobilabs.com${pdata[0]['p_img'][s]}', fit: BoxFit.fill),),
                                  ),
                                ),
                            ],
                          ),
                      ...
                      child: SingleChildScrollView(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(' ${pdata[0]["p_other_desc"]['p_pack']}',style: TextStyle(fontSize: 15,fontFamily: 'cera bold',color: UiColors.primary),),
                                      ],
                                    ),],
                                ),
                                Container(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: TextStyle(fontSize: 15,color: Colors.grey),
                                          ...
                                          //Text('${indexval}',style: TextStyle(fontFamily: 'cera medium',fontSize: 17),),
                                          SizedBox(width: 15,),
                                          InkWell(
                                            onTap: ()async{
                                              FocusScope.of(context).requestFocus(new FocusNode());
                                ...
                                child: Center(
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text('${ConstantsN.currency}${pdata[0]['p_mrp']} ',style: TextStyle(color: Colors.black,fontFamily: 'archivo medium',decoration: TextDecoration.lineThrough,fontSize: 14),),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      UiButton(text: '  Update  ', ontap: () async{
                        print('${pdata[0]['p_name']}''(${pdata[0]["p_other_desc"]['p_pack']})');
                        if(pdata.length!=0) {
                          showDialog(
                          ...
                          List added = await PostMethod('showOrders',
                              jsonEncode({
                                ...
                                "p_name": '${pdata[0]['p_name']}''(${pdata[0]["p_other_desc"]['p_pack']})',
                    ...
                    Column(
                      children: [
                        Container(
                          height: MediaQuery.of(context).size.height/3.25,
                          child:PinchZoom(
                            child: Image.memory(Base64Codec().decode(onstage) ,),
                            resetDuration: const Duration(milliseconds: 100),
                            maxScale: 2.5,
                            onZoomStart: (){print('Start zooming');},
                            onZoomEnd: (){print('Stop zooming');},
                              ...
                              GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                      height: 80,width: 80,
                                      decoration: BoxDecoration(border:Border.all() ),
                                      child: Image.memory(Base64Codec().decode(pdata[0]['p_img'][s]) ,)),
                                ),
                              ),
                          ],
                        ),
                      ...
                      child: Column(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Container(
                                      width:280,
                                      child: Text('${pdata[0]['p_name']}',style: TextStyle(fontSize: 23,fontFamily: 'cera medium'),overflow: TextOverflow.ellipsis,maxLines: 2,)),
                                  SizedBox(height: 5),
                                  Text(pdata[0]['p_maincategory'],style: TextStyle(fontSize: 15,color: Colors.black54),),
                                ],
                              ),
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: TextStyle(fontSize: 15,color: Colors.grey),
                              ...
                              Column(
                                children: [
                                  if(pdata[0]['p_mrp']!=pdata[0]['p_sellingprice'])
                                    Text('${ConstantsN.currency} ${pdata[0]['p_mrp']} ',style: TextStyle(fontSize: 20,fontFamily: 'cera medium',decoration: TextDecoration.lineThrough),),
                                  Text(
                                   '${salesp}',
                                    style: TextStyle(fontSize: 20,fontFamily: 'cera medium'),),
                                ],
                              ),
                          ...
                          Align(
                              alignment: Alignment.topLeft,
                              child: Text('Product Detail',style: TextStyle(fontFamily: 'cera medium',fontSize: 15,color: Colors.black54),)),
                          SizedBox(height: 10,),
                          Align(
                              alignment: Alignment.topLeft,
                              child: Text(pdata[0]['p_desc'],style: TextStyle(wordSpacing: 2,height: 1.2,color: Colors.black54),)),
                          SizedBox(height: 5,),
                          Divider( thickness: 1,color: UiColors.primarySec,),
                          ...
                          UiButton(text: 'Update', ontap: () async{
                            ...
                            if(added[0]['status']=='ok'){
                              ...
                              Navigator.pushAndRemoveUntil(
                                context, MaterialPageRoute(builder: (context) => BaseScreen(toScreen: 'home',)),
