...
class cateofproduct extends StatefulWidget {
  final catname;
  const cateofproduct({Key? key, this.catname}) : super(key: key);

  @override
  _cateofproductState createState() => _cateofproductState();
}

class _cateofproductState extends State<cateofproduct> {
  List newbestdata=[];
  newandbestcall() async{
   
    List respona=await GetMethod('addCategory/RHVR5A/${widget.catname}');
    setState(() {
      newbestdata=respona;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
          ...
          appBar: shopappBar(widget.catname,context),
