...
import 'package:onshop/Views/Home/Sales_Details.dart';
...
class _MyOrdersState extends State<MyOrders> {
  ...
  newandbestcall() async{
    ...
    List respona=await GetMethod('showOrders/RH46IB/${ShopStorage.read('mob')}/confirmedorders/all');
    setState(() {
      Data=respona;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
          ...
          appBar: shopappBar('My Orders',context),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Data.length==0 ?
                  loadmyorders():
                  (Data.length!=0 && Data[0]['status']=='ok')  ?
                  Column(
                    children: [
                 ...
                 Padding(
                   ...
                   child: TextButton(
                    onPressed: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context)=> BillDetails(invnumber: Data[k]['bill_number'], phone: ShopStorage.read('mob'), tt: '0.1' ,)));
                    },
                     child: Container(
                           ...
                           children: [
                             Row(
                               ...
                               children: [
                                 ...
                                 SizedBox(width: 10,),
                                 Text('Bill No:${Data[k]['bill_number'].substring(7)}',style: TextStyle(color: Colors.black,fontSize: 15),)
                               ],
                             ),
                             Column(
                               children: [
                                 Container(
                                   width: 100,
                                     child: Text('${readTimestamp(Data[k]['b_number'].toString())}',style: TextStyle(fontFamily: 'archivo bold',color: Colors.black54,fontSize: 12,),textAlign: TextAlign.right,))
                               ],
                             )
                           ],
                         ),
