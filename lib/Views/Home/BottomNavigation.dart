...
class Bottomnavigation extends StatefulWidget {
  final fromWhere;
  final toScreen;
  const Bottomnavigation({Key? key, this.fromWhere, this.toScreen}) : super(key: key);
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                      onTap: (){
                          Navigator.pushAndRemoveUntil(
                                        context, MaterialPageRoute(builder: (context) => BaseScreen(toScreen: 'category',)),
                                            (Route<dynamic> route) => false,
                                      );
                  ...
                  GestureDetector(
                      ...
                      child: ActivePage == 'mycart' ? SvgPicture.asset('assets/homepage/Mycart__active.svg' ,   ): (StreamBuilder(
                  ...
                  GestureDetector(
                      onTap: (){
                           Navigator.pushAndRemoveUntil(
          context, MaterialPageRoute(builder: (context) => BaseScreen(toScreen: 'favourite',)),
              (Route<dynamic> route) => false,
        );
                      },
