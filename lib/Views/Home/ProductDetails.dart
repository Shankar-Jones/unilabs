...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  @override
  void initState(){
     if(widget.data['p_fav'].contains(ShopStorage.read('mob'))){
     setState(() {
          iconshow=true;
     });
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
              ...
              Column(
                children: [
                  ...
                  items: [
                    ...
                    imageProvider: MemoryImage(Base64Codec().decode(widget.data['p_img'][s]) ,),
          ...
          children:  [
            for(int k=0;k<widget.data['p_img'].length;k++)
           GestureDetector(
              onTap: () => _controller.animateToPage(k),
              child: Container(
                width: 12.0,
                height: 12.0,
                ...
                decoration: BoxDecoration(
                    ...
                    color: (Theme.of(context).brightness == Brightness.dark
                            ? Colors.white
                            : Colors.black)
                        .withOpacity(_current == k ? 0.9 : 0.4)),
           )),
          ]
          ),
                ],
                        ...
                        child: Padding(
                          ...
                          child: SingleChildScrollView(
                                ...
                                Row(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      Container(
                                          width:280,
                                          child: Text('${widget.data['p_name']}',style: TextStyle(fontSize: 23,fontFamily: 'Archivo bold'),overflow: TextOverflow.ellipsis,maxLines: 2,)),
                                      SizedBox(height: 5),
                                      Text(widget.data['p_maincategory'],style: TextStyle(fontSize: 15,color: Colors.black54),),
                                      ],
                                    ),
                            ...
                            iconshow=false;
                                  ...
                                  List res=await PutMethod('showOrders/RH46IB/${widget.data['p_barcode']}', 
                                  jsonEncode({
                             "type" : "remove",
                         ...
                         List resa=await PutMethod('showOrders/RH46IB/${widget.data['p_barcode']}', 
                                  jsonEncode({
                             "type" : "add",
                             "phone" : ShopStorage.read('mob')
                          }));
                                ...
                                SizedBox(height: 20,),
                                 Row(
                                      ...
                                      children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                SizedBox(width: 25,),
                                                Text('${indexval}',style: TextStyle(fontFamily: 'Archivo bold',fontSize: 17),),
                                                SizedBox(width: 25,),
                                                InkWell(
                                                  onTap: ()async{

                                                     if(indexval<widget.data['p_inventory'] ){
                                                            setState(() {
                                                             indexval= indexval+1;
                                                            });
                                                     }
                                        ...
                                        Column(
                                          children: [
                                              if(widget.data['p_mrp']!=widget.data['p_sellingprice'])
                                               Text('\u{20B9} ${widget.data['p_mrp']} ',style: TextStyle(fontSize: 20,fontFamily: 'Archivo bold',decoration: TextDecoration.lineThrough),),
                                                Text('\u{20B9} ${widget.data['p_sellingprice']} ',style: TextStyle(fontSize: 20,fontFamily: 'Archivo bold'),),
                                          ],
                                        ),
                                ...
                                Align(
                                  ...
                                  child: Text('Product Detail',style: TextStyle(fontFamily: 'Archivo bold',fontSize: 15,color: Colors.black54),)),
                                      SizedBox(height: 10,),
                                    Align(
                                         alignment: Alignment.topLeft,
                                      child: Text(widget.data['p_desc'],style: TextStyle(wordSpacing: 2,height: 1.2,color: Colors.black54),)),
                                  SizedBox(height: 5,),
                                Divider( thickness: 1,color: UiColors.primarySec,),
                                ...
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                      Text('Rating',style: TextStyle(fontFamily: 'Archivo bold',fontSize: 15),),
                                    Row(
                                      children: [
                                        Icon(
    ...
    List added=await PostMethod('showOrders',  
        jsonEncode({
            ...
            "p_salesprice" : widget.data['p_sellingprice'],
            "p_qty" :indexval,
